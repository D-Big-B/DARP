...
class VideoDetailsFormProvider {
	...
	public function createReportForm() {
		$statement = "<p>Flagged videos are reviewed by DARP staff 24 hours a day, seven days a week to determine whether they violate any guidelines. If any guidelines are violated, then the video will be taken down. </p>";
