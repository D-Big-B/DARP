...
<body oncontextmenu='return false;' style='background-color:rgb(18, 18, 18);'>
    <div class="signInContainer">
        <div class="column" >
            ...
            <div class="header">
                <img src="./assets/images/icons/DARP.svg" title="logo" alt="Site logo">
                <h3>Sign Up</h3>
                <span>to continue to DARP</span>
            </div>
            ...
            <div class="loginForm">
                <form action="signUp.php" method="POST">
                  ...
                  <br>
                  <span><input type="checkbox" id="terms_conditions_checkbox" required onclick="signTerms_Conditions();">&nbsp;&nbsp;By signing up with DARP, I agree to the <a href='#' onclick="$('#tandcModal').modal('show');">Terms & Conditions.</a></span>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="background-color:black;">
                  <div class="modal-header">
                    <h5 class="modal-title">Terms & Conditions | DARP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                  <p>1. DARP enforces the usage of DTC(DARP Coins) for all transactions and actions performed by the user.</p>
                  <p>2. DARPrs will spend 5 DTC coins each time they like, dislike a video  or subscribe a channel. 
                  <br>In case of subscribing or liking action, of these 5 DTC coins , 4 will be rewarded to the content creator(uploader) and 1 coin will be deposited with DARP as DARP Community Fund. 
                  <br>In case of disliking, all the 5 DTC coins will be deposited with DARP as DARP Community Fund.
                  </p>

                  <p>3. DARP reserves the right to decide in its sole discretion whether Your Content, Your DARP Account and/or Your use of the DARP Service violates these Terms for any reasons other than copyright infringement, such as, but not limited to, pornography, obscenity, or excessive length. 
                  Failure to comply with these Terms may result in <br>
                  (i) Your Content being blocked without prior notice and/or <br>
                  (ii) Your DARP Account being deactivated without prior notice and/or <br>
                  (iii) In addition, DARP reserves the right to report any violation of these provisions to applicable legal authorities and You may be personally liable to criminal sanctions applicable to the content in question (fines and imprisonment), in addition to any applicable civil damages.</p>

                  <p>4. Due to its tokenized business model, DARP is 100% ad-free and does not collect any personal data from its users. DARP respects the privacy of its users.</p>
                  <p>5. DARP reserves the right to accept/deny users from purchasing and selling DTC tokens. DARP also reserves the right to destroy the smart contract without providing prior notice.</p>
                  </div>
...
function signTerms_Conditions() {
  ...
  var text = `# TERMS & CONDITIONS #
              ...
              1. DARP enforces the usage of DTC(DARP Coins) for all transactions and actions performed by the user.
              
              2. DARPers will spend 5 DTC coins each time they like, dislike a video  or subscribe a channel. 
                  
                  In case of subscribing or liking action, of these 5 DTC coins , 4 will be rewarded to the content creator(uploader) and 1 coin will be deposited with DARP as DARP Community Fund. 
                  In case of disliking, all the 5 DTC coins will be deposited with DARP as DARP Community Fund.
                  
              3. DARP reserves the right to decide in its sole discretion whether Your Content, Your DARP Account and/or Your use of the DARP Service violates these Terms for any reasons other than copyright infringement, such as, but not limited to, pornography, obscenity, or excessive length. 
                  Failure to comply with these Terms may result in 

                  (i) Your Content being blocked without prior notice and/or 

                  (ii) Your DARP Account being deactivated without prior notice and/or 

                  (iii) In addition, DARP reserves the right to report any violation of these provisions to applicable legal authorities and You may be personally liable to criminal sanctions applicable to the content in question (fines and imprisonment), in addition to any applicable civil damages.

              4. Due to its tokenized business model, DARP is 100% ad-free and does not collect any personal data from its users. DARP respects the privacy of its users.
              
              5. DARP reserves the right to accept/deny users from purchasing and selling DTC tokens. DARP also reserves the right to destroy the smart contract without providing prior notice.`;
